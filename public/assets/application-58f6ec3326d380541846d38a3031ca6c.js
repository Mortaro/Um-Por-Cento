...
(function() {
  $(document).on('ready page:load', function() {
    $('[href=#navigation]').click(function() {
      var navigation;
      navigation = $(this).closest('#navigation');
      if ($(this).hasClass('active')) {
        ...
        if (navigation.css('float') === 'left') {
          navigation.find('nav').slideDown(function() {
            return navigation.find('nav ul:last-of-type a').css('margin', '0 5px');
          });
        } else {
          $('#blur').fadeIn();
          navigation.animate({
    ...
    return $('#navigation nav a').hover(function() {
      return $('#bird span:first-of-type').stop().fadeOut('slow');
    }, function() {
      return $('#bird span:first-of-type').stop().fadeIn('slow');
    });
  });

  $.fn.waypoint = function(down, up) {
    var that;
    that = $(this);
    if (that.size() === 0) {
      return that;
...
(function() {
  $(document).on('ready page:load', function() {
    return $('#comumcc').waypoint(function() {
      return $('#comumcc').addClass('active');
    }, function() {
      return $('#comumcc').removeClass('active');
    });
  });
...
(function() {
  $(document).on('ready page:load', function() {
    return $('#intro-slider').height($(window).height());
  });

}).call(this);
(function() {
  $(document).on('ready page:load', function() {
    return $('#time-percentage').waypoint(function() {
      ...
      return setTimeout(function() {
        ...
        return setTimeout(function() {
          ...
          return setTimeout(function() {
            return $('#time-percentage em:nth-child(3)').removeClass('active');
          }, 2000);
        }, 2000);
      }, 2000);
    }, function() {
      ...
      return $('#time-percentage em').removeClass('active');
    });
  });
...
(function() {
  $(document).on('ready page:load', function() {
    $('.members li').not('.placeholder').click(function() {
      $('.members-expanded').show();
      return $("[data-index=" + ($(this).attr('data-index')) + "]").fadeIn();
    });
    return $('.members-expanded a[href="#"]').click(function() {
      $(this).closest('li').fadeOut().closest('ul').fadeOut();
      return false;
    });
  });
...
(function() {
  $(document).on('ready page:load', function() {
    $('.text-section ul a').click(function() {
      var target;
    ...
    return $('.text-section ul').waypoint(function() {
      return $('.text-section ul').addClass('active');
    }, function() {
      return $('.text-section ul').removeClass('active');
    });
  });
